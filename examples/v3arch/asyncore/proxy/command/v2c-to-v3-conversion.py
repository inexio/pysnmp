...
* remote Agent listening at 135.181.62.68:161
...
| $ snmpget -v3 -l authNoPriv -u usr-md5-none -A authkey1 -ObentU 135.181.62.68:161  1.3.6.1.2.1.1.1.0
...
config.addTargetAddr(
    ...
    udp.DOMAIN_NAME + (2,), ('135.181.62.68', 161),
