...
* over IPv4/UDP
* to an Agent at 135.181.62.68:161
* for an OID in tuple form

This script performs similar to the following Net-SNMP command:

| $ snmpget -v3 -l authNoPriv -u usr-md5-none -A authkey1 -E 80004fb805636c6f75644dab22cc -n da761cfc8c94d3aceef4f60f049105ba -ObentU 135.181.62.68:161  1.3.6.1.2.1.1.1.0
...
config.addTargetAddr(
    ...
    udp.DOMAIN_NAME, ('135.181.62.68', 161),
    'my-creds'
)
