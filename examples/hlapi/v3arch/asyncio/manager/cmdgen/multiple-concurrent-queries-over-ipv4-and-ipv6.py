...
| $ snmpget -v2c -c public demo-snmp.thola.io3161 SNMPv2-MIB::sysDescr.0
...
loop.run_until_complete(
    asyncio.wait(
        [getone(snmpEngine, ('demo-snmp.thola.io', 1161)),
         getone(snmpEngine, ('demo-snmp.thola.io', 2161)),
         getone(snmpEngine, ('demo-snmp.thola.io', 3161))]
    )
)
