...
| $ snmpset -v2c -c public -ObentU demo-snmp.thola.io 1.3.6.1.2.1.1.9.1.3.1 s 'New description' 1.3.6.1.2.1.1.9.1.4.1 t 12
...
transportDispatcher.sendMessage(
    encoder.encode(reqMsg), udp.DOMAIN_NAME, ('demo-snmp.thola.io', 161)
)
