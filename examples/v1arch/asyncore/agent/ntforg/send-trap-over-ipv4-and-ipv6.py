...
* to a Manager at demo-snmp.thola.io:162 and [::1]
...
| $ snmptrap -v1 -c public udp:demo-snmp.thola.io 1.3.6.1.4.1.20408.4.1.1.2 127.0.0.1 1 0 12345
...
transportDispatcher.sendMessage(
    encoder.encode(trapMsg), udp.DOMAIN_NAME, ('demo-snmp.thola.io', 162)
)
